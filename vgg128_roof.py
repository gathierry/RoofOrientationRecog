...
if not os.path.isfile(caffe_root + 'models/VGG_CNN_M_128/VGG_CNN_M_128.caffemodel'):
    print("Downloading pre-trained CaffeNet model...")

caffe.set_mode_cpu()

model_def = caffe_root + 'models/VGG_CNN_M_128/VGG_CNN_M_128_deploy.prototxt'
model_weights = caffe_root + 'models/VGG_CNN_M_128/VGG_CNN_M_128.caffemodel'
...
np.savetxt('vgg128_fc7_feature_batch_1.txt', train_x)
...
np.savetxt('vgg128_fc7_feature_batch_1_test.txt', test_x)