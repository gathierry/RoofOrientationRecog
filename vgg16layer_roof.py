...
if not os.path.isfile(caffe_root + 'models/VGG_16layer/VGG_ILSVRC_16_layers.caffemodel'):
    print("Downloading pre-trained CaffeNet model...")

caffe.set_mode_cpu()

model_def = caffe_root + 'models/VGG_16layer/VGG_ILSVRC_16_layers_deploy.prototxt'
model_weights = caffe_root + 'models/VGG_16layer/VGG_ILSVRC_16_layers.caffemodel'
...
np.savetxt('vgg16_fc7_feature_batch_1.txt', np.squeeze(train_x))
...
np.savetxt('vgg16_fc7_feature_batch_1_test.txt', np.squeeze(test_x))